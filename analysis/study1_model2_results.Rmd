...
# Model 2: Joint response response time model
...
bayesplot::mcmc_areas(fit.mcmc, pars = paste0("prec[",1:5,"]"), prob = 0.8); ggsave("fig/study1_model2_prec_dens.pdf")
bayesplot::mcmc_acf(fit.mcmc, pars = paste0("prec[",1:5,"]")); ggsave("fig/study1_model2_prec_acf.pdf")
bayesplot::mcmc_trace(fit.mcmc, pars = paste0("prec[",1:5,"]")); ggsave("fig/study1_model2_prec_trace.pdf")
...
```{r study1-model2-ppd, cache=TRUE, autodep=TRUE}
