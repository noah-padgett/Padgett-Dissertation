...
call_fx <- function(con)
{
  ...
  model.fit <-  R2jags::jags(
    model=paste0(getwd(),"/data/padgettn/full_model_test/full_model_ifa_w_misclass_rt_jags.txt")
...
suppressWarnings(write.csv(RESULTS2, paste0(getwd(),"/data/padgettn/full_model_test/time_test_5cat_cond_1_2.csv"), col.names = T, row.names = F))
